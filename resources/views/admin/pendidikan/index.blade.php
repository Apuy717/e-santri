    ...
    <div class="col-lg-6">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="collapse show" id="asr"><br>
          <center>
            <h4><a href="" class="badge badge-success" data-toggle="modal" data-target="#kamar">Add Fakultas</a></h4>
          </center>
          <div class="card-body">
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <center>
                      <a href="/dashboard/pendidikan/delete/fak/{{$f->id}}" class="badge badge-danger" OnClick="return confirm('Apakah anda yakin mau menghapus data fakultas atau sekolah?');">Delete</a>
                    </center>
                  </td>
                </tr>
                @endforeach
    ...
    <div class="col-lg-6">
      <div class="card shadow mb-4">
        ...
        <div class="collapse show" id="collapseCardExample"><br>
          <center>
            <h4><a href="" class="badge badge-success" data-toggle="modal" data-target="#exampleModal">Add Prodi</a></h4>
          </center>
          <div class="card-body">
            <table class="table table-bordered">
              <thead>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <center>
                      <a href="/dashboard/pendidikan/delete/pro/{{$p->id}}" class="badge badge-danger" OnClick="return confirm('Apakah anda yakin mau menghapus data prodi atau jurusan ?');">Delete</a>
                    </center>
                  </td>
                </tr>
                @endforeach
