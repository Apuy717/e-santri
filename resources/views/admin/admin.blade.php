...
@section('footer')
<script src="{{url('admin/vendor/highcharts.js')}}"></script>
<script>
    Highcharts.chart('jk', {
        chart: {
            type: 'column'
        ...
        series: [{
            name: 'Jml',
            data: [{!!json_encode($tes) !!}, {!!json_encode($L) !!}, {!!json_encode($P) !!}]}]
    });
</script>
<script>
    Highcharts.chart('js2', {
        chart: {
            type: 'column'
        },
        title: {
