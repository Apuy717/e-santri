...
<div class="container-fluid">
  ...
  <form action="/dashboard/persensi/alfa" method="post">
    ...
    <button type="submit" name="submit" OnClick="return confirm('Hay Admin Apkah Anda Yakin? Mau Melakukan Auto Alfa..!! Proses ini akan membuat alfa bagi santri yang belum melakukan persesnsi');">simpan auto alfa</button>
  </form>
  <hr>
  <h3>absen manual</h3>
  <hr>
