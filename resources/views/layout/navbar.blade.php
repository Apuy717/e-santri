 <body id="page-top">
   ...
   <div id="wrapper">
     ...
     <!-- Sidebar -->
     <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" aria-expanded="false" id="accordionSidebar">
       ...
       <li class="nav-item">
         ...
         <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
           <div class="bg-white py-2 collapse-inner rounded">
             ...
             <a class="collapse-item" href="{{url('/dashboard/verifikasi')}}">Verifikasi User</a>
             <h6 class="collapse-header">Santri Undifined:</h6>
             <a class="collapse-item" href="{{url('/dashboard/santri/undifined')}}">User No-Data</a>
