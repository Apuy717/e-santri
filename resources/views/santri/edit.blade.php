        ...
        <form action="/user/update/{{$santri->id}}" method="post" class="contactForm" enctype="multipart/form-data" style=" width: 90%;">
          ...
          <div class="form-group text-left">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control input-tanggal" name="tgl_lahir" id="tgl_lahir" data-rule="tgl_lahir" autocomplete="ogg" required="on" value="{{$santri->tgl_lahir}}" readonly />
            </div>
          ...
          <div class="form-row text-left">
            ...
            <div class="form-group col-lg-6">
              ...
              <input type="text" name="awal_mondok" class="form-control input-tanggal" id="awal_mondok" required="on" autocomplete="off" readonly value="{{$santri->awal_mondok}}">
            </div>
