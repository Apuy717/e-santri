      ...
      <form action="/user/edit/ortu/{{$ortu->id}}" method="post" class="contactForm" enctype="multipart/form-data" style=" width: 90%;">
        ...
        <div class="col-xl-10">
          <div class="form-group">
            ...
            <input id="input-b1" name="gambar" type="file" class="file" data-show-upload="false" data-show-remove="true" data-show-cancel="false" data-show-preview="false" value="{{$ortu->gambar}}">
